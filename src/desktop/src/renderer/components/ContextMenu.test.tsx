...
describe('<ContextMenu />', () => {
  it('renders every item with its label and accelerator', () => {
    render(<ContextMenu x={0} y={0} items={ITEMS} onSelect={vi.fn()} onClose={vi.fn()} />);
  ...
  it('positions the menu via fixed coordinates', () => {
    render(<ContextMenu x={120} y={45} items={ITEMS} onSelect={vi.fn()} onClose={vi.fn()} />);
  ...
  it('selecting an enabled item invokes onSelect', async () => {
    ...
    render(<ContextMenu x={0} y={0} items={ITEMS} onSelect={onSelect} onClose={vi.fn()} />);
  ...
  it('Escape closes the menu', () => {
    const onClose = vi.fn();
    render(<ContextMenu x={0} y={0} items={ITEMS} onSelect={vi.fn()} onClose={onClose} />);
